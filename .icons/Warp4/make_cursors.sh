...
echo "14  7  7 SIZENESW.png" | xcursorgen -p src > cursors/bottom_left_corner
echo "14  6  6 SIZENWSE.png" | xcursorgen -p src > cursors/bottom_right_corner
echo "19  6  9 SIZENS.png"   | xcursorgen -p src > cursors/bottom_side
...
echo "25 12 11 WAIT.png"     | xcursorgen -p src > cursors/clock
...
#echo "26 12 12 MOVE.png"     | xcursorgen -p src > cursors/fleur
...
echo "19  9  7 SIZEWE.png"   | xcursorgen -p src > cursors/left_side
...
echo "19  9  7 SIZEWE.png"   | xcursorgen -p src > cursors/right_side
...
echo "14  6  6 SIZENWSE.png" | xcursorgen -p src > cursors/top_left_corner
echo "14  7  7 SIZENESW.png" | xcursorgen -p src > cursors/top_right_corner
echo "19  6  9 SIZENS.png"   | xcursorgen -p src > cursors/top_side
...
echo "25 12 11 WAIT.png"     | xcursorgen -p src > cursors/watch
echo "15  3  6 TEXT.png"     | xcursorgen -p src > cursors/xterm
  else
